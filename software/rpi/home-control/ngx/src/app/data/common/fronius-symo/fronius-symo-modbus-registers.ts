...
export type FroniusSymoModbusIds =
    ...
    // Extended Measurment and Status Model: int+SF
           ...
           40191 |                          40195 |                         40199 |
                            40203 |                         40207 |
            40211 | 40212 | 40213 | 40214 | 40215 |         40217 | 40218 |
                    40222 |         40224 | 40225 |
    ...
    40280 | 40281 | 40282 | 40283 | 40284 |
                    40292 | 40293 | 40294 | 40295 |         40297 |         40299 |
    40300 | 40301
    ;
...
export class FroniusSymoModbusRegisters {
    ...
    static regDefById: { [ id in FroniusSymoModbusIds ]: IRegisterDefinition } =  {
        ...
        40130: { uid: '40130', label: 'vartgq2',         class: ModbusNumber, id: 40130,                           code: 's16', access: 'R', format: '%f', type: { int: { scale: '40133' }}, unit: 'var',                                     description: 'Continuous var capability of the inverter quadrant 2.' },
        40131: { uid: '40131', label: 'vartgq3',         class: ModbusNumber, id: 40131,                           code: 's16', access: 'R', format: '%f', type: { int: { scale: '40133' }}, unit: 'var',                                     description: 'Continuous var capability of the inverter quadrant 3.' },
        ...
        40137: { uid: '40137', label: 'pfrtgq2',         class: ModbusNumber, id: 40137,                           code: 's16', access: 'R', format: '%f', type: { int: { scale: '40140' }},                                                  description: 'Minimum power factor capability of the inverter in quadrant 2' },
        40138: { uid: '40138', label: 'pfrtgq3',         class: ModbusNumber, id: 40138,                           code: 's16', access: 'R', format: '%f', type: { int: { scale: '40140' }},                                                  description: 'Minimum power factor capability of the inverter in quadrant 3' },
        ...
        40149: { uid: '40149', label: 'pad',             class: ModbusNumber, id: 40149,                           code: 's16', access: 'R', format: '%d',                                                                                    description: 'Pad register' },
        ...
        40159: { uid: '40159', label: 'varmaxq2',        class: ModbusNumber, id: 40159,                           code: 's16', access: 'R', format: '%f',   type: { int: { scale: '40177' }}, unit: 'var',                                   description: 'Setpoint of maximum reactive power in quadrant 2. Default ro vartgq2.' },
        40160: { uid: '40160', label: 'varmaxq3',        class: ModbusNumber, id: 40160,                           code: 's16', access: 'R', format: '%f',   type: { int: { scale: '40177' }}, unit: 'var',                                   description: 'Setpoint of maximum reactive power in quadrant 3. Default ro vartgq3.' },
        ...
        40164: { uid: '40164', label: 'pfminq2',         class: ModbusNumber, id: 40164,                           code: 's16', access: 'R', format: '%.1f', type: { int: { scale: '40179' }},                                                description: 'Setpoint for minimum power factor value in quadrant 2. Default to pfrtgq2' },
        40165: { uid: '40165', label: 'pfminq3',         class: ModbusNumber, id: 40165,                           code: 's16', access: 'R', format: '%.1f', type: { int: { scale: '40179' }},                                                description: 'Setpoint for minimum power factor value in quadrant 3. Default to pfrtgq3' },
        ...
        40167: { uid: '40167', label: 'varact',          class: ModbusNumber, id: 40167,                           code: 'u16', access: 'R', format: '%f',                                                                                    description: 'Not supported' },
        40168: { uid: '40168', label: 'clctotva',        class: ModbusNumber, id: 40168,                           code: 'u16', access: 'R', format: '%f',                                                                                    description: 'Not supported' },
        40169: { uid: '40169', label: 'maxrmprte',       class: ModbusNumber, id: 40169,                           code: 'u16', access: 'R', format: '%f',                                                                                    description: 'Not supported' },
        40170: { uid: '40170', label: 'ecpnomhz',        class: ModbusNumber, id: 40170,                           code: 'u16', access: 'R', format: '%f',                                                                                    description: 'Not supported' },
        40171: { uid: '40171', label: 'connph',          class: ModbusNumber, id: 40171,                           code: 'u16', access: 'R', format: '%f',                                                                                    description: 'Not supported' },
        ...
        40191: { uid: '40191', label: 'actvah',          class: ModbusNumber, id: [{ first: 40191, last: 40194 }],  code: 'u64', access: 'R', format: '%.0f',                                  unit: 'VAh',                                   description: 'Not supported (AC lifetime apparent energy output).' },
        40195: { uid: '40195', label: 'actvarhq1',       class: ModbusNumber, id: [{ first: 40195, last: 40198 }],  code: 'u64', access: 'R', format: '%.0f',                                  unit: 'varh',                                  description: 'Not supported (AC lifetime reactive energy output quadrant 1).' },
        40199: { uid: '40199', label: 'actvarhq2',       class: ModbusNumber, id: [{ first: 40199, last: 40202 }],  code: 'u64', access: 'R', format: '%.0f',                                  unit: 'varh',                                  description: 'Not supported (AC lifetime reactive energy output quadrant 2).' },
        40203: { uid: '40203', label: 'actvarhq3',       class: ModbusNumber, id: [{ first: 40203, last: 40206 }],  code: 'u64', access: 'R', format: '%.0f',                                  unit: 'varh',                                  description: 'Not supported (AC lifetime reactive energy output quadrant 3).' },
        40207: { uid: '40207', label: 'actvarhq4',       class: ModbusNumber, id: [{ first: 40207, last: 40210 }],  code: 'u64', access: 'R', format: '%.0f',                                  unit: 'varh',                                  description: 'Not supported (AC lifetime reactive energy output quadrant 4).' },
        40211: { uid: '40211', label: 'varaval',         class: ModbusNumber, id: 40211,                            code: 's16', access: 'R', format: '%f', type: { int: { scale: '40212' }},                                                 description: 'Not supported (Amount of VARs available without impacting watts output' },
        ...
        40213: { uid: '40213', label: 'waval',           class: ModbusNumber, id: 40213,                            code: 'u16', access: 'R', format: '%f', type: { int: { scale: '40214' }},                                                 description: 'Not supported (Amount of Watts available).' },
        ...
        40215: { uid: '40215', label: 'stsetlimmsk',     class: ModbusNumber, id: [{ first: 40215, last: 40216 }],  code: 'u32', access: 'R', format: '%d',                                                                                   description: 'Not supported (Bit Mask indicating setpoint limit(s) reached. Bits are persistent and must be cleared by the controller)' },
        ...
        40218: { uid: '40218', label: 'tmsrc',           class: ModbusNumber, id: [{ first: 40218, last: 40221 }],  code: 'string', access: 'R', format: '%s',                                                                                description: 'Source of time synchronization.' },
        40222: { uid: '40222', label: 'tms',             class: ModbusNumber, id: [{ first: 40222, last: 40223 }],  code: 'u32', access: 'R', format: '%d',                                                                                   description: 'Seconds since 01-01-2000 00:00 UTC' },
        40224: { uid: '40224', label: 'riso',            class: ModbusNumber, id: 40224,                            code: 'u16', access: 'R', format: '%f', type: { int: { scale: '40225' }},                                                 description: 'Not supported (Isolation resistance)' },
        40225: { uid: '40225', label: 'riso_sf',         class: ModbusNumber, id: 40225,                            code: 's16', access: 'R', format: '%d',                                                                                   description: 'Scale factor: Isolation resistance (not supported)' },
        ...
        40236: { uid: '40236', label: 'wmaxlimpct_rmptmss', class: ModbusNumber, id: 40236,                            code: 'u16', access: 'R/W', format: '%d', unit: 's',                                                                      description: 'Not supported (Ramp time for moving from current setpoint to new setpoint)' },
        ...
        40241: { uid: '40241', label: 'outpfset_rmptms',    class: ModbusNumber, id: 40241,                            code: 'u16', access: 'R',   format: '%d', unit: 's',                                                                      description: 'Not supported (Ramp time for moving from current setpoint to new setpoint)' },
        ...
        40243: { uid: '40243', label: 'varwmaxpct',         class: ModbusNumber, id: 40243,                            code: 's16', access: 'R',   format: '%d',                                                                                 description: 'Not supported (Reactive power in percent of wmax)' },
        ...
        40245: { uid: '40245', label: 'varavalpct',         class: ModbusNumber, id: 40245,                            code: 's16', access: 'R',   format: '%f', type: { int: { scale: '40253' }}, unit: '%',                                    description: 'Not supported (Reactive power in percent of varaval)' },
        ...
        40248: { uid: '40248', label: 'varpct_rmptms',      class: ModbusNumber, id: 40248,                            code: 'u16', access: 'R',   format: '%d', unit: 's',                                                                      description: 'Not supported (Ramp time for moving from current setpoint to new setpoint)' },
        ...
        40310: { uid: '40310', label: 'vachamax',           class: ModbusNumber, id: 40310,                            code: 'u16', access: 'R',   format: '%d', unit: 'VA',                                                                     description: 'Not supported (Setpoint for maximum charging VA).' },
        ...
        40313: { uid: '40313', label: 'storaval',           class: ModbusNumber, id: 40313,                            code: 'u16', access: 'R',   format: '%f', type: { int: { scale: '40327' }}, unit: 'Ah',                                   description: 'Not supported (State of charge).' },
        40314: { uid: '40314', label: 'inbatv',             class: ModbusNumber, id: 40314,                            code: 'u16', access: 'R',   format: '%f', type: { int: { scale: '40328' }}, unit: 'V',                                    description: 'Not supported (Internal battery voltage).' },
        ...
        40318: { uid: '40318', label: 'inoutwrte_wintms',   class: ModbusNumber, id: 40318,                            code: 'u16', access: 'R',   format: '%d', unit: 's',                                                                      description: 'Not supported (Time window for charge/discharge rate)' },
        40319: { uid: '40319', label: 'inoutwrte_rvrttms',  class: ModbusNumber, id: 40319,                            code: 'u16', access: 'R',   format: '%d', unit: 's',                                                                      description: 'Not supported (Time period for charge/discharge rate)' },
        40320: { uid: '40320', label: 'inoutwrte_rmptms',   class: ModbusNumber, id: 40320,                            code: 'u16', access: 'R',   format: '%d', unit: 's',                                                                      description: 'Not supported (Ramp time for moving from current setpoint to new setpoint)' },
        ...
        40263: { uid: '40263', label: 'tmsper',             class: ModbusNumber, id: 40263,                            code: 'u16', access: 'R', format: '%d',                                                                                   description: 'Not supported (Timestamp period)' },
        ...
        40265: { uid: '40265', label: 'idstr_1',            class: ModbusNumber, id: [{ first: 40265, last: 40272 }],  code: 'string', access: 'R', format: '%s',                                                                                description: 'String 1: Innut Id String' },
        ...
        40276: { uid: '40276', label: 'dcwh_1',             class: ModbusNumber, id: [{ first: 40276, last: 40277 }],  code: 'u32',    access: 'R', format: '%.2f', type: { int: { scale: '40259' }}, unit: 'Wh',                                description: 'String 1: DC lifetime energy' },
        ...
        40280: { uid: '40280', label: 'tmp_1',              class: ModbusNumber, id: 40280,                            code: 's16',    access: 'R', format: '%d',   unit: 's',                                                                   description: 'Not supported (String 1: temperature)' },
        40281: { uid: '40281', label: 'dcst_1',             class: ModbusNumber, id: 40281,                            code: 'u16',    access: 'R', format: '%d',   unit: '°C',                                 range: { min: 0, max: 8 },       description: 'String 1: operating state' },
        40282: { uid: '40282', label: 'dcevt_1',            class: ModbusNumber, id: [{ first: 40282, last: 40283 }],  code: 'u32',    access: 'R', format: '%d',                                                                                description: 'Not supported (String 1: module events)' },
        40283: { uid: '40283', label: 'id_2',               class: ModbusNumber, id: 40283,                            code: 'u16',    access: 'R', format: '%d',                                               range: { values: [ 1 ] },        description: 'String 2: Input Id' },
        40284: { uid: '40284', label: 'idstr_2',            class: ModbusNumber, id: [{ first: 40284, last: 40291 }],  code: 'string', access: 'R', format: '%s',                                                                                description: 'String 2: Innut Id String' },
        40292: { uid: '40292', label: 'dca_2',              class: ModbusNumber, id: 40292,                            code: 'u16',    access: 'R', format: '%.1f', type: { int: { scale: '40256' }}, unit: 'A',                                 description: 'String 2: DC current' },
        40293: { uid: '40293', label: 'dcv_2',              class: ModbusNumber, id: 40293,                            code: 'u16',    access: 'R', format: '%.1f', type: { int: { scale: '40257' }}, unit: 'V',                                 description: 'String 2: DC voltage' },
        40294: { uid: '40294', label: 'dcw_2',              class: ModbusNumber, id: 40294,                            code: 'u16',    access: 'R', format: '%.1f', type: { int: { scale: '40258' }}, unit: 'W',                                 description: 'String 2: DC power' },
        40295: { uid: '40295', label: 'dcwh_2',             class: ModbusNumber, id: [{ first: 40295, last: 40296 }],  code: 'u32',    access: 'R', format: '%.2f', type: { int: { scale: '40259' }}, unit: 'Wh',                                description: 'String 2: DC lifetime energy' },
        40297: { uid: '40297', label: 'tms_2',              class: ModbusNumber, id: [{ first: 40297, last: 40298 }],  code: 'u32',    access: 'R', format: '%d',   unit: 's',                                                                   description: 'String 2: timestamp' },
        40299: { uid: '40299', label: 'tmp_2',              class: ModbusNumber, id: 40299,                            code: 's16',    access: 'R', format: '%d',   unit: 's',                                                                   description: 'Not supported (String 2: temperature)' },
        40300: { uid: '40300', label: 'dcst_2',             class: ModbusNumber, id: 40300,                            code: 'u16',    access: 'R', format: '%d',   unit: '°C',                                 range: { min: 0, max: 8 },       description: 'String 2: operating state' },
        40301: { uid: '40301', label: 'dcevt_2',            class: ModbusNumber, id: [{ first: 40301, last: 40302 }],  code: 'u32',    access: 'R', format: '%d',                                                                                description: 'Not supported (String 2: module events)' },
    ...
    static regDefByLabel: {
        ...
        status: {
            ...
            tmsrc:      FroniusSymoModbusRegisters.regDefById[40218],
            tms:        FroniusSymoModbusRegisters.regDefById[40222],
            riso:       FroniusSymoModbusRegisters.regDefById[40224],
            riso_sf:    FroniusSymoModbusRegisters.regDefById[40225]
        },
        control: {
        ...
        inverterExtension: {
            ...
            id_2:    FroniusSymoModbusRegisters.regDefById[40283],
            idstr_2: FroniusSymoModbusRegisters.regDefById[40284],
            dca_2:   FroniusSymoModbusRegisters.regDefById[40292],
            dcv_2:   FroniusSymoModbusRegisters.regDefById[40293],
            dcw_2:   FroniusSymoModbusRegisters.regDefById[40294],
            dcwh_2:  FroniusSymoModbusRegisters.regDefById[40295],
            tms_2:   FroniusSymoModbusRegisters.regDefById[40297],
            tmp_2:   FroniusSymoModbusRegisters.regDefById[40299],
            dcst_2:  FroniusSymoModbusRegisters.regDefById[40300],
            dcevt_2: FroniusSymoModbusRegisters.regDefById[40301]
        }
    };
}
