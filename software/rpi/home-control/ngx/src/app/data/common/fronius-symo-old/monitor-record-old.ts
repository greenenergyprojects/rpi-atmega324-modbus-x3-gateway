...
// //     values?: { [id: string ]: INibe1155Value };
// }
...
//             rv.hwcMonitorRecord = this._data.hwcMonitorRecord;
//         }
//         return rv;
//     }
...
//     public get hwcMonitorRecord (): hwc.IMonitorRecord {
...
//             const dt = Date.now() - new Date(this._data.hwcMonitorRecord.activePower.createdAt).getTime();
//             if (dt < 10000) {
